...
#define SD_APP_SD_STATUS_APP_CMD_BIT                    0x0D
#define SD_APP_SEND_NUM_WR_BLOCKS_APP_CMD_BIT           0x16
#define SD_APP_SET_WR_ERASE_COUNT_APP_CMD_BIT           0x17
#define SD_APP_SD_SEND_OP_COND_APP_CMD_BIT              0x29
#define SD_APP_SET_CLR_CARD_DETECT_APP_CMD_BIT          0x2A
#define SD_APP_SEND_SCR_APP_CMD_BIT                     0x33
